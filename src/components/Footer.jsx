...
const Footer = () => {
  return (
    <footer className="bg-gray-800 text-white py-6 px-4 flex flex-col items-center">
      {/* Social Media Icons */}
      ...
      <div className="text-center mb-4">
        ...
        <form className="flex">
          <input
            ...
            className="p-2 border-2 border-gray-300 rounded-l"
          />
          <button
            type="submit"
      ...
      <div className="text-sm text-center">
        <p>2024 Sbuko Acres. All rights reserved.</p>
        <div className="mt-2">
      ...
      <a
        href="#"
        className="fixed bottom-4 right-4 bg-orange-500 text-white p-3 rounded-full shadow-lg hover:bg-orange-600"
        title="Scroll to Top"
      >
        ↑
      </a>
